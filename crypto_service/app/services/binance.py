...
# Mapping symbol -> DefiLlama chain/protocol name for TVL enrichment
TVL_MAPPING = {
    'BTCUSDT': 'Bitcoin',
    'ETHUSDT': 'Ethereum',
    'SOLUSDT': 'Solana',
...
# DefiLlama chains to track for detailed TVL change
DETAILED_CHAINS = [
