...
from app.services.defillama.config import DEFILLAMA_API_BASE, DEFILLAMA_CHANS_URL, HISTORY_SLUG_OVERRIDES, create_client
...
async def get_chain_1d_change(slug: str, is_protocol: bool = False) -> float:
    try:
        ...
        url = f"{DEFILLAMA_API_BASE}/v2/historicalChainTvl/{fetch_slug}"
